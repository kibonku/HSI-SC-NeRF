...
# CONFIGURATION
# ---------------------------------------------------------
PAR_DIR = r"nerfstudio/_custom_dataset_application-paper"

source_list = ['S10/S10_t1', 'S10/S10_t2', 'S10/S10_t3', 'S10/S10_t4']

SOURCE = source_list[3]     # Replace

TARGET_BANDS = 204           # if using full bands
RGB_BAND_INDICES = (70, 53, 19)

INPUT_DIR = f"{PAR_DIR}/1.raw/{SOURCE}/REFLECTANCE"
BASE_OUTPUT_DIR = f"{PAR_DIR}/2.pre/{SOURCE}/{TARGET_BANDS}_hsi_WR_mask"
rgb_dir = f"{PAR_DIR}/2.pre/{SOURCE}/pseudo_rgb_WR_mask"
